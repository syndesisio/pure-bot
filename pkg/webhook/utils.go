...
func createContextWithSpecifiedStatus(contextName string, status commitStatus, description string, repo *github.Repository, pr *github.PullRequest, gh *github.Client) error {
